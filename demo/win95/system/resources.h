...
typedef enum {
  ...
  IMAGE_SCROLL_LEFT,
  IMAGE_SCROLL_RIGHT,
  IMAGE_SCROLL_UP_DISABLED,
  IMAGE_SCROLL_DOWN_DISABLED,
  IMAGE_SCROLL_LEFT_DISABLED,
  IMAGE_SCROLL_RIGHT_DISABLED,
  ...
  IMAGE_PAINT_16,
  IMAGE_WORDWIZ_16,
  IMAGE_NOTEPAD_DOCUMENT_16,
  IMAGE_NOTEPAD_DOCUMENT_32,
  __IMAGE_COUNT
} image_id_t;
