...
void demo_ui(BITMAP *buffer) {
  ...
  cig_begin_layout(buffer, cig_rect_make(0, 0, SCREEN_W, SCREEN_H));
  ...
  /* Right content (a grid) */
	...
	void demo_grid_element(const cig_rect_t frame) {
	...
	if (grid_demo == 0) {
		...
		*/
		...
		demo_grid_element(cig_rect_make(0, 0, 73, 50));
		demo_grid_element(cig_rect_make(0, 0, 73, 75));
		demo_grid_element(cig_rect_make(0, 0, 73, 100));
		demo_grid_element(cig_rect_make(0, 0, 73, 125));
		...
		/* We'll add some elements with increasing height */
		demo_grid_element(cig_rect_make(0, 0, 50, 84));
		demo_grid_element(cig_rect_make(0, 0, 60, 84));
		demo_grid_element(cig_rect_make(0, 0, 70, 84));
		demo_grid_element(cig_rect_make(0, 0, 80, 84));
		demo_grid_element(cig_rect_make(0, 0, 90, 84));
  ...
  cig_pop_frame(); /* Pop horizontal stack layout */
	...
	{
		cig_push_frame(cig_rect_make(200, IM_B - 100, 240, 50));
