...
M_INLINED void assert_rect_equal(const cig_r exp, const cig_r act, unsigned int line) {
  char message[64];
...
M_INLINED void assert_vec2_equal(const cig_v exp, const cig_v act, unsigned int line) {
  char message[48];
